...
Label(fr2,text="LP4",font=("algerian",38),compound="center",fg="Orange").pack()
Label(fr2,text="CC",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
...
Label(fr2,text="MMCOE",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
def airline():
    root.destroy()
    root1=Tk()
    ...
    def signup():
                 def success():
                    ...
                    if a != []:
                          ...
                          messagebox.showinfo('Signed Up',"Congratulation You are Successfully Signed Up")
                          con.commit()
                 ...
                 def signin():
                     ...
                     #Error for displaying the image
    ...
    def flights():
        ...
        if variable.get()=="Delhi" and variable1.get()=="U.S.A":
            messagebox.showerror('Oops!',"Sorry No direct flights available for this root")
